...
cond_syscall(sys_cmgroup_newgroup);
cond_syscall(sys_cmgroup_associate);
cond_syscall(sys_cmgroup_dissociate);
cond_syscall(sys_cmgroup_get_concurrency_value);
cond_syscall(sys_cmgroup_set_concurrency_value);
cond_syscall(sys_io_set_cmgroup);
